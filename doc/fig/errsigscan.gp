...
plot [:][3:7e3] \
    "../../data/scan/sigprd_t1e8_g.dat"  u 1:($6**2)            w l        lt 1 lw 4                   notitle, \
    "../../data/scan/sigrun_t1e8_g.dat"  u 1:($4)               w p  pt 13 ps 1.4                      notitle, \
    -1                                                          w lp pt 13 lt 1 lw 4 ps 1.4            t "Gaussian, {/Times-Italic T} = 10^{/*0.8 8}", \
    ...
    -1                                                          w lp pt 5  lt 4 lw 4  lc rgb "#000000" t "Bandpass, {/Times-Italic T} = 10^{/*0.8 8}", \
