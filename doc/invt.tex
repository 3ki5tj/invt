...
with the inverse-time schedule
such that the bias potential is computed as
a weighted adaptive average of the histogram\cite{marsili2006, barducci2008},
...
\note{The table of symbols is listed in Table \ref{tab:symbols}.
  ...
  \begin{tabular}{l | p{12cm} }
    ...
    $\chi_i$        &   $\chi_i \equiv \ln \frac{ p_i } { p^*_i } - \sum_{ j = 1 }^n \rho_j \, \ln \frac{ p_j } { p^*_j }$. \\
