...
to take into account for the initial error.
...
%
The relative update magnitudes, $w_{ij}$,
constitute a matrix $\mathbf w$.
%
...
although the elements can be negative.
...
we note that for a periodic variable, $\phi_i$,
...
in real metadynamics simulations.
