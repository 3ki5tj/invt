...
whereas the next two terms are added to
adopt the open boundary condition.
%
If $i$ represents a periodic variable,
the last two terms can be dropped under
the minimum image convention for $|i-j|$\cite{dama2014}.
