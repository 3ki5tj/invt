...
\begin{center}
  ...
  \caption{
    \label{fig:massq}
    Geometric construction of the optimal schedule,
    $\alpha(t)$,
...
%%
%\note{Derivation.
%  Integrating $\dot \vartheta_k = c_k$ yields
%  \begin{equation}
%    \vartheta_k(t) = c_k \left(t + t_{k0} \right).
%  \tag{UK}
%  \label{neq:ui_solution}
%  \end{equation}
%  Given that $\vartheta_k(T) = 1$ and
%  $\vartheta_k(0) = e^{-\lambda_k \, q(T)}$,
%  we have
%  $$
%  c_k = \frac{ 1 }{ T + t_{k0} },
%  \quad
...
Eq. \eqref{eq:EA_sbin1} [cf. Eq. \eqref{eq:Gamma_G_sum}]:
%
$$
...
Then, from Eq. \eqref{eq:mu_from_lambda},
we have
\begin{equation}
  \mu_l
  =
