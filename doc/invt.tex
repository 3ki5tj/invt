...
which recovers the Langfeld, Lucini and Rago (LLR)
...
adaptive Gaussian umbrella sampling below.
...
with a spacing of $2L$.
%
For configuration sampling for each umbrella,
we used the Wolff algorithm\cite{wolff1989, newman}
(which appeared to be more efficient than the Metropolis algorithm),
...
\begin{center}
  ...
  \caption{
    \label{fig:pt_hist}
    Application of adaptive Gaussian umbrella sampling
