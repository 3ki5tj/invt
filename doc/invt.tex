...
We shall refer to the updating schemes
given by Eqs. \eqref{eq:mu_cardinal_pbc}
and \eqref{eq:mu_cardinal_refl}
as cardinal updating schemes,
since in the large $n$ limit, Eq. \eqref{eq:mu_cardinal_pbc}
is reduced to a cardinal sine function.
