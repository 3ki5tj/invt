...
we get $c = 1/(T + t_0)$,
and from the case of $t' = 0$,
we get $q(T) = \ln(1 + T/t_0)$.
%
Since the above optimization is performed
under a fixed $q(T)$, below
one will choose a proper value of $q(T)$,
or, equivalently, of $t_0$, to complete the optimization.
