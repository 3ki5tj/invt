...
\begin{equation}
  w_{ij}
  =
  \frac{1}{\rho_i} \sum_{k=1}^n \lambda_k \, \phi_{ki} \, \phi_{kj}
  .
  \notag
\end{equation}
...
%
$$w_{ij} = \sum_{k=1}^{K+1} \phi_{ki} \, \phi_{kj},$$
%
...
the eigenvalues are known and
we can use the inversion formula, Eq. \eqref{eq:mu_from_lambda}
