...
the single-bin updating scheme used by the WL algorithm
...
for the single-bin updating WL algorithm
...
\subsubsection{Inverse-time schedule}
...
%
Compare with Eqs. \eqref{eq:alpha_limit1} and \eqref{eq:alpha_limit2}.
