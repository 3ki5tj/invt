...
%
\begin{equation}
  V_i = \ln p^*_i - \ln p_i + \mathrm{const.}
  ,
  \label{eq:Vi_target}
\end{equation}
%
...
%
This relation thus furnishes a practical aim of convergence for FDS
methods---adjusting the bias potential to make the
observed distribution, which can be computed from the normalized histogram,
...
continual improvement of the bias potential, hence that of the PMF,
as simulation lengthens.

The second type of methods,
which we will refer to as the adaptive FDS methods,
address the above shortcomings
by continually and incrementally update the target distribution.
...
\subsubsection{Error and linear approximation}



Next, we need to define the error in the bias potential.
%
...
Second, the bias potential following Eq. \eqref{eq:vt_diffeq}
...
that ignore high-frequency eigenmodes.
%
