...
\begin{center}
  ...
  \caption{
    ...
    %
    \note{The figure is produced by \texttt{doc/fig/errsbin.gp}.
      The data are produced by the script \texttt{invt2run.py},
...
of $T = 10^8$,
while the minimum around $\sigma = 0$
became more favorable as the simulation lengthens.
%
However,
...
%
Further, in all cases the bandpass scheme
appeared to be superior to the Gaussian updating scheme.
