...
\end{equation}
%
This error is roughly equal to the overall histogram flatness
and thus it can be conveniently estimated\cite{zhou2005, zhou2008}
...
The error function defined in Eq. \eqref{eq:error_def}
...
Note that in some previous studies\cite{zhou2005, zhou2008},
the histogram flatness, Eq. \eqref{eq:F_def},
was previously used to define the error,
