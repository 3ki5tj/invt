...
optimizing Eq. \eqref{eq:error_asym1}
can lead to an algebraically complex expression for $\alpha(t)$.
%
In practice, it is more useful to find a simple expression for $\alpha(t)$
...
Second, we shall show that the optimal $\lambda$
...
%
This shows that for a relatively short simulation,
hence relative large value of $r$,
