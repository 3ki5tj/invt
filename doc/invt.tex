...
\begin{aligned}
  ...
  =
  \sum_{l=0}^{b} m_l \, \cos\frac{(j+l-\frac12)k\pi}{n},
\end{aligned}
$$
where we have used
$$
...
&=
- \theta^{(k)}_j \, m_0
+\sum_{l=0}^{b} m_l \, 2 \, \cos\frac{lk\pi}{n} \, \cos\frac{(j-\frac12)k\pi}{n}
\\
&= \theta^{(k)}_j \, \lambda_k,
\end{aligned}
$$
...
%
\begin{equation}
\lambda_k = m_0 + \sum_{l = 1}^b 2 \, m_l \cos \frac{k l \pi}{n}.
