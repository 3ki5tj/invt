...
although ideally they should be estimated from the data
...
or to elongate the preliminary simulation
under the constant magnitude.
...
This equation can also be derived\footnote{From Eq. \eqref{eq:uhatt},
...
from the self-healing umbrella sampling
method\cite{marsili2006},
and it serves as
...
follows from the plain average,
$\omega(t) = 1$ (for $t > 0$),
