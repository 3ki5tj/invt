...
\begin{abstract}
  ...
  is the inverse of the time or number of sampling steps with a proper shift.
  %
\end{abstract}
...
is unity, but the origin of $t$ should be shifted
...
\note{(cheng, the inset in figure two should be replotted to fix the dynamic range of the gray scale.)}
%
\begin{equation}
  \sigma
  \approx
...
\note{(Cheng, we should give a  description of the test system)}
...
\note{The table of symbols is listed in Table \ref{tab:symbols}.
  ...
  \begin{tabular}{l | p{12cm} }
    ...
    $g$             &   Degeneracy factor, $2$ for a periodic variable, or $1$ a non-periodic one. \\
