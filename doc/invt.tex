...
a simple protocol to optimally control the updating magnitude,
which is borrow from the single-bin updating scheme.
...
where were in agreement with the discussion in Appendix \ref{sec:schedule_geometry}.
%
...
%
This construction, 
as a generalization of the LLR algorithm\cite{langfeld2012, pellegrini2014},
...
(possibly because of the non-equilibrium sampling effect
