...
can lead to an algebraically complex expression for $\alpha(t)$.
%
In practice, it is more useful to find
...
%
We refer to this scheme as the global sampling scheme.
%
In the second sampling scheme,
...
suggesting that the latter is the safer choice
when the optimal value is unknown.


Our final observation is that the error function
in the two cases differed only by a multiplicative constant.
%
...
which gives rise to the multiplicative constant mentioned above.
...
%
We again find good agreement between simulation and analytical results.
%
...
dominate the error function,
according to Eq. \eqref{eq:error_invt},
as the equilibrium error under a fixed updating magnitude
is proportional to $\lambda_k \, \Gamma_k$.
%
...
%
This causes $\lambda$ to shift toward
...
because the weight of a longer-wavelength mode
is further multiplied by much larger value of $\Gamma_k$.
