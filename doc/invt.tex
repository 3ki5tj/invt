...
\begin{center}
  ...
  \caption{
    ...
    %
    \note{
      The figure was produced by \texttt{tikz}. % doc/fig/massq.gp}.
    }%
  }
\end{center}
\end{figure}
...
%
Naturally, $\rho_i = 1/n$ in this case.
%
...
but not the corresponding eigenvalues.
%
...
\begin{center}
  ...
  \caption{
    ...
    but join the initial error curve
