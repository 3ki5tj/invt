...
the distribution peaks at $Q = 0$,
and decreases with $Q$.
%
According to Eq. \eqref{eq:q_opt},
the ordinate of the distribution curve
...
For the asymptotic error, we have,
from Eqs.
...
\end{equation}
%
The optimal value of $q(T)$ that minimizes
...
\label{eq:opt_qT}
\end{equation}
i.e., the initial updating magnitude
should be half of $\alpha_0$.
...
\begin{tikzpicture}
  ...
  %\node[inner sep=0, minimum size=0] (R2) at (4.6, 0) {};
  %\node[inner sep=0, minimum size=0] (R3) at (5.7, 1) {};
