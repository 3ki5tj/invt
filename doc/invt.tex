...
\begin{abstract}
  ...
  the initial updating magnitude should always be half of
...
in which the schedule becomes the velocity of a free particle,
and the final error plays the role of the action.
%
In this way, the optimal schedule follows the equation of motion
...
Here we will call a simulation that targets
...
we will turn to the problem of choosing
...
O. Nassar, Dr. C. Lai, Dr. S. Ou, D. Stuhlsatz, C. Myers, and O. Samoylova
...
\section{\label{sec:invt_discussion}
On the inverse-time schedule}


\subsection{\label{sec:wltoinvt}
...
\subsection{\label{sec:adaptinvt}
Inverse-time schedule from adaptive averaging
}

Result of the increase of the sample size.

Final bias potential is already the average,
No further trajectory averaging is needed.
Fixed magnitude, improvable by trajectory averaging.
